...
if(localStorage.getItem("bestBrain")){
    for(let i=0;i<cars.length;i++)
    {
        ...
        if(i!=0)
        {
            NeuralNetwork.mutate(cars[i].brain,0.0005);
        }
    }
...
const traffic=[
    ...
    new Car(road.getLaneCenter(1),-1075,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(1),-1200,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(0),-1300,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(2),-1325,30,50,"DUMMY",2),
    ...
    new Car(road.getLaneCenter(0),-2050,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(1),-2075,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(1),-2200,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(0),-2300,30,50,"DUMMY",2),
    new Car(road.getLaneCenter(2),-2325,30,50,"DUMMY",2),
];
